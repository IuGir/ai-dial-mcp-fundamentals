...
@mcp.tool(description="Provides full user information by user_id")
...
@mcp.tool(description="Deletes user by user_id")
async def delete_user(user_id: int) -> str:
    """Deletes user by user_id"""
    return await user_client.delete_user(user_id)


@mcp.tool(description="Searches for users by name, surname, email and gender")
...
@mcp.tool(description="Adds new user into the system")
...
@mcp.tool(description="Updates user by user_id")
